...
class MLP(nn.Module):
    def __init__(self, input_size: int, history_size: int, output_size: int, hidden_dims_list: List[int]):
        """
    ...
    def __str__(self):
        return f"MLP[in={self.input_size * self.history_size},hid={self.hidden_dims_list},out={self.output_size}]"

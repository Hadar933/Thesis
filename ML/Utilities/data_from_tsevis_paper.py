...
def generate_dummy_data(t_start: str, t_end: str, phi_frequencies: list[float], phi_amplitudes: list[float],
						time_delta: str, add_NaN: bool = True, add_noise: bool = True,
...
def generate_dummy_target(t_start, t_end, sample_freq: str, add_NaN: bool = True,
						  add_noise: bool = True, nan_probability: float = 0.02):
